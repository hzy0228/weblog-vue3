    ...
    <el-dialog v-model="isArticlePublishEditorShow" :fullscreen="true" :show-close="false"
      ...
      <el-form :model="form" ref="publishArticleFormRef" label-position="top" size="large" :rules="rules">
        ...
        <el-form-item label="内容" prop="content">
          <!-- Markdown 编辑器 -->
          <MdEditor v-model="form.content" @onUploadImg="onUploadImg" editorId="publishArtilceEditor"/>
        </el-form-item>
...
import {deleteArticle, getArticleDetail, getArticlePageList, publishArticle, updateArticle} from '@/api/admin/article'
